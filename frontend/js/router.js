...
const TENANT_VIEWS = {overview:'view-t-overview', backups:'view-t-backups', explorer:'view-t-explorer', identity:'view-t-identity', activity:'view-t-activity', settings:'view-t-settings'};
...
const TENANT_TITLES = {overview:'Overview', backups:'Backups', explorer:'Explorer', identity:'Users & Access', activity:'Activity', settings:'Settings'};
...
function enterTenantPage(t, page){
  ...
  if(page === 'explorer') openExplorer(t);
